...
After a successful copy, the source access path remains initialized and usable according to its previous ownership, borrowing, capability, and dependency-contract state.
