...
It participates in a coherence domain only when it is declared in that domain or explicitly imported into it according
to implementation coherence rules.
...
Implementations of compiler-known traits obey ordinary implementation visibility, coherence, overload-family, import,
ownership, borrowing, contract, and target availability rules.
