...
`Range<T>`, `Future<T>`, `Task<T>`, `PanicReport`, raw pointers, and selected compiler-known support types can have protected
representation when their owning rules require it.
