...
17. [Core data standard library](core-data-standard-library.md)
...
The [Bray source style guide](../contributing/bray-style-guide.md) defines the layout and organization of Bray source.
