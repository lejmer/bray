...
A pattern is checked against a subject type. The subject type determines which pattern forms are valid and what bindings, refinements, ownership state, and flow-sensitive contract changes the pattern can produce.
