...
Iteration-bearing expressions use the compiler-known `Iterable` and `Iterator` traits defined in [Iteration traits](../types/implementations.md#iteration-traits).
