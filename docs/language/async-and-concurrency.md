...
lifetimes, cancellation, execution requirements, runtime integration, cross-run memory visibility, synchronization, atomics, and
the portable standard-library concurrency surface.
