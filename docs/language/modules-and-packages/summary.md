...
Each runtime product instance owns its realized product statics. Exact native-thread attachments within that product own
their thread-local statics until deterministic detach cleanup completes.
