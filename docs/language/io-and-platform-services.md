...
## Initial Public Declaration Surface

The declarations in this section are the canonical initial public contract. The bodyless forms describe declaration surfaces and
...
Later additions can extend these modules without changing the names, parameter modes, result shapes, ownership behavior, or
blocking requirements defined here.
