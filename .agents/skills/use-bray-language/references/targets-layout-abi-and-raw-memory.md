...
See [device memory](https://github.com/lejmer/bray/blob/develop/docs/language/targets-layout-abi-and-raw-memory/device-memory.md) and [foreign and platform interoperability](https://github.com/lejmer/bray/blob/develop/docs/language/targets-layout-abi-and-raw-memory/foreign-standard-library.md#target-specific-modules).
