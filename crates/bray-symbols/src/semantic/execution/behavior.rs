...
use crate::TrustedCapabilityRequirement;
...
impl CallablePhaseBehavior {
    ...
    pub fn with_execution_properties(
        mut self,
        properties: impl IntoIterator<Item = crate::ExecutionProperty>,
    ) -> Self {
    ...
    pub fn execution_properties(&self) -> &[crate::ExecutionProperty] {
