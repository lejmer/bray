...
use bray_bound_tree::{BoundUnit, BoundUnitKey, CheckedControlFlowFacts, CheckedStorageFacts};
...
pub(super) struct CompilationState {
    ...
    pub(super) checked_storage: UnitFactCache<CheckedStorageFacts>,
    ...
    pub fn load(request: CompilationRequest) -> Result<Self, CompilationLoadError> {
        ...
        Ok(Self {
            state: Arc::new(CompilationState {
                ...
                checked_storage: UnitFactCache::new(),
