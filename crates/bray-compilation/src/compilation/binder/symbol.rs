...
pub(in crate::compilation) use environment::{
    declaration_generic_parameter_ids, generic_parameter_ids, has_visible_generic_parameters,
    type_binder, type_scope, visible_generic_const_parameters, visible_generic_parameters,
};
