...
pub(in crate::compilation::export) fn export_checked_source_template(
...
pub(in crate::compilation::export) struct SourceTemplateInput {
...
impl SourceTemplateInput {
    pub(in crate::compilation::export) const fn new(
        kind: InterfaceCheckedTemplateInputKind,
        target: Option<BoundReferenceTarget>,
        ty: TypeId,
    ) -> Self {
...
pub(in crate::compilation::export) struct SourceTemplateRequest<'a> {
    pub(in crate::compilation::export) kind: CheckedTemplateKind,
    pub(in crate::compilation::export) unit: &'a BoundUnit,
    pub(in crate::compilation::export) types: &'a CheckedExpressionTypes,
    pub(in crate::compilation::export) selections: &'a CheckedSemanticSelections,
    pub(in crate::compilation::export) literals: &'a CheckedLiteralValues,
    pub(in crate::compilation::export) expression: SyntaxAnchor,
    pub(in crate::compilation::export) inputs: Vec<SourceTemplateInput>,
    pub(in crate::compilation::export) behavior: InterfaceCheckedTemplateBehavior,
}

pub(in crate::compilation::export) fn export_source_template(
...
pub(in crate::compilation::export) struct SourceTemplateBuilder<'export, 'values, 'unit> {
    pub(in crate::compilation::export) export: &'export mut SemanticExporter<'values>,
    unit: &'unit BoundUnit,
    types: &'unit CheckedExpressionTypes,
    pub(in crate::compilation::export) selections: &'unit CheckedSemanticSelections,
...
impl<'export, 'values, 'unit> SourceTemplateBuilder<'export, 'values, 'unit> {
    ...
    pub(in crate::compilation::export) fn expression(
        &mut self,
        ...
        let interface_ty = match &operation {
            InterfaceCheckedTemplateOperation::Input(input) => self
                ...
                .get(usize::try_from(input.raw()).map_err(|_| {
                    super::super::capacity_export_error("template_input_reference", input.raw())
                })?)
        ...
        match expression {
            ...
            BoundExpression::Structured(expression) => match expression.kind() {
                ...
                | BoundStructuredExpressionKind::SliceIndex => {
                    self.index(expression_id, expression)
                }
                BoundStructuredExpressionKind::TrustBoundary => {
                    ...
                    let index = usize::try_from(node.raw()).map_err(|_| {
                        super::super::capacity_export_error("template_node_reference", node.raw())
                    })?;
...
fn index(length: usize) -> Result<u32, PackageInterfaceExportError> {
    u32::try_from(length)
        .map_err(|_| super::super::capacity_export_error("checked_template_node_count", length))
}

pub(in crate::compilation::export) const fn incomplete(
    reason: &'static str,
) -> PackageInterfaceExportError {
    PackageInterfaceExportError::InvalidCompilationCause(
        super::super::PackageInterfaceInvalidCompilationCause::CheckedTemplate { reason },
    )
}
