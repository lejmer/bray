...
use bray_ir::{
    ...
    MirMemoryOperation, MirOperand, MirOperationKind, MirPlace,
    MirProjectionKind, MirRuntimeReference, MirSourceAnchor, MirStorageKind, MirStoreKind, MirUnitBuilder,
};
use bray_runtime_interface::RuntimeAbiRole;
use bray_symbols::{
    BorrowKind,
    CallableSignature, CallableSignatureQuery, NamedTypeSymbolId, SymbolQueryRequest, TypeAssociatedLifecycleSlot,
    TypeData, TypeId,
};
...
use super::super::support::{closed_array_length, projected_lifecycle_place, receiver_codegen_type};
...
impl Compilation {
    ...
    pub(in crate::compilation::product::realization) fn push_compiler_known_lifecycle_operations(
        ...
        let Some(role) = super::super::super::super::foreign::compiler_known_representation(self, *definition)
        else {
            return Ok(false);
        };
    ...
    pub(in crate::compilation::product::realization) fn lifecycle_callable(
        ...
        let callable =
            super::super::super::super::implementation::callable_instance(values, member, [*substitution])?;
