...
/// Returns the common command-line parser style palette.
...
/// Renders styled command-line parser output with terminal escape sequences.
pub fn render_styled_text(text: &StyledStr) -> String {
    text.ansi().to_string()
}
