...
pub use argument::{
    ...
    DiagnosticDocumentParseKind, DiagnosticEmissionArtifactOperation,
...
pub use emission::{
    DiagnosticBindingFailure, DiagnosticCheckerFailure, DiagnosticCheckerLocal,
    ...
    DiagnosticEmissionStagingFailure, DiagnosticForeignQueryFailure,
    ...
    DiagnosticPackageInterfaceFailure, DiagnosticPatternInputFailure,
    ...
    DiagnosticSemanticValueFailure, DiagnosticStorageFlowFailure, DiagnosticTestCatalogFailure,
