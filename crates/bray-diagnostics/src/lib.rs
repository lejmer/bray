...
pub use argument::{
    ...
    DiagnosticExternalToolFailureKind, DiagnosticExternalToolOperation,
    DiagnosticFrameDescriptorFailure, DiagnosticIoErrorKind, DiagnosticLinkInputKind,
...
pub use emission::{
    ...
    DiagnosticConstantEvaluationFailure, DiagnosticConstantInputFailure,
