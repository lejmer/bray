...
pub enum DiagnosticPackageInterfaceFailure {
    ...
    FragmentCoordinationCycle(Box<[String]>),
    FragmentMissingReference {
        table: String,
        reference: u32,
    },
    FragmentUnexpectedPackageRecord(String),
...
impl DiagnosticPackageInterfaceFailure {
    pub const fn as_str(&self) -> &'static str {
        match self {
            ...
            Self::FragmentCoordinationCycle(_) => "fragment_coordination_cycle",
            Self::FragmentMissingReference { .. } => "fragment_missing_reference",
            Self::FragmentUnexpectedPackageRecord(_) => "fragment_unexpected_package_record",
