use bray_bound_tree::{
    BoundExpressionId, BoundUnit, CheckedBodyBehavior, CheckedControlFlow,
    CheckedDependencyContracts, CheckedExpressionTypes, CheckedLiteralValues, CheckedPatterns,
    CheckedRefinements, CheckedSemanticSelections, Liveness, StorageFlow, StoragePlan,
};
...
use super::error::{LoweringInputError, LoweringInputKind};
    ...
    fn input_rejects_storage_flow_that_disagrees_with_the_storage_plan() {
        ...
        let flow = StorageFlow::try_new(
            ...
            [StorageOperationDecision::new(
                bray_bound_tree::BoundOperationPoint::Evaluation(expression.into()),
                expression,
