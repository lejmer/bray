...
///
/// Unknown or malformed source-level target uses are represented by ordinary semantic recovery
/// and diagnostics. Provider failure is reserved for an unavailable dependency or cancellation.
