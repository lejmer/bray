...
pub use syntax::{
    ...
    PathSyntaxBuilder, PredicateDeclarationSyntax, PredicateDeclarationSyntaxBuilder,
    PredicateModifiersSyntax, PredicateModifiersSyntaxBuilder, PredicateParameterListSyntax,
    ...
    StructDeclarationSyntax, StructDeclarationSyntaxBuilder, SymbolDirectiveSyntax,
    SymbolDirectiveSyntaxBuilder, TargetDirectiveSyntax, TargetDirectiveSyntaxBuilder,
    TestDirectiveSyntax, TestDirectiveSyntaxBuilder, TraitApplicationSyntax,
    TraitApplicationSyntaxBuilder, TraitBodySyntax, TraitBodySyntaxBuilder, TraitDeclarationSyntax,
    TraitDeclarationSyntaxBuilder, TraitImplementationBodySyntax,
    TraitImplementationBodySyntaxBuilder, TraitModifiersSyntax, TraitModifiersSyntaxBuilder,
    ...
    UnionDeclarationSyntaxBuilder, UnnamedTraitImplementationDeclarationSyntax,
