...
pub use expression::{
    ...
    AssertionExpressionSyntax, AssertionExpressionSyntaxBuilder, AwaitExpressionSyntax,
    AwaitExpressionSyntaxBuilder, BooleanFoldExpressionSyntax, BooleanFoldExpressionSyntaxBuilder,
    BorrowExpressionSyntax, BorrowExpressionSyntaxBuilder, BreakExpressionSyntax,
    BreakExpressionSyntaxBuilder, CallOperationSyntax, CallOperationSyntaxBuilder,
    CatchExpressionSyntax, CatchExpressionSyntaxBuilder, ConditionalElseSyntax,
    ConditionalElseSyntaxBuilder, ConditionalExpressionSyntax, ConditionalExpressionSyntaxBuilder,
    ...
    LambdaExpressionSyntax, LambdaExpressionSyntaxBuilder, LeadingDotVariantExpressionSyntax,
    LeadingDotVariantExpressionSyntaxBuilder, LiteralExpressionSyntax,
    LiteralExpressionSyntaxBuilder, LoopExpressionSyntax, LoopExpressionSyntaxBuilder,
    ...
    PanicExpressionSyntax, PanicExpressionSyntaxBuilder, PrimaryExpressionSyntax,
    PrimaryExpressionSyntaxBuilder, ResultPropagationExpressionSyntax,
