...
pub use expression::{
    ...
    PrimaryExpressionSyntaxBuilder, ReturnExpressionSyntax, ReturnExpressionSyntaxBuilder,
    SliceIndexOperationSyntax, SliceIndexOperationSyntaxBuilder, SpawnExpressionSyntax,
    SpawnExpressionSyntaxBuilder, StructConstructionBodySyntax,
