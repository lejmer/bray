...
define_source_syntax_node! {
    ...
    pub struct TraitImplementationConstantMemberDefinitionSyntax {
        builder: TraitImplementationConstantMemberDefinitionSyntaxBuilder,
        kind: SyntaxKind::TraitImplementationConstantMemberDefinition,
        source_slot: "trait_implementation_constant_member_definition.source",
        node_name: "trait implementation constant member definition",
        range_description: "trait-implementation-constant-member-definition",
        debug_name: "TraitImplementationConstantMemberDefinitionSyntax",
        builder_debug_name: "TraitImplementationConstantMemberDefinitionSyntaxBuilder",
        skipped_syntax: true,
        required_tokens: [
            {
                /// Returns the required `const` keyword token.
                ...
                push_const_keyword;
                kind: SyntaxKind::ConstKeyword;
                slot: "trait_implementation_constant_member_definition.const_keyword";
            },
            {
                /// Returns the required constant name token.
                identifier_token;
                ...
                push_identifier_token;
                kind: SyntaxKind::IdentifierToken;
                slot: "trait_implementation_constant_member_definition.identifier_token";
            },
            {
                /// Returns the required colon token.
                colon_token;
                ...
                push_colon_token;
                kind: SyntaxKind::ColonToken;
                slot: "trait_implementation_constant_member_definition.colon_token";
            },
            {
                /// Returns the required initializer equals token.
                equals_token;
                ...
                push_equals_token;
                kind: SyntaxKind::EqualsToken;
                slot: "trait_implementation_constant_member_definition.equals_token";
            },
            {
                /// Returns the required semicolon token.
                semicolon_token;
                ...
                push_semicolon_token;
                kind: SyntaxKind::SemicolonToken;
                slot: "trait_implementation_constant_member_definition.semicolon_token";
            }
        ],
        optional_tokens: [],
        required_children: [],
