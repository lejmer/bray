...
define_lifecycle_body_node_with_required_result! {
    ...
    source_slot: "trait_implementation_scope_enter_member_declaration.source",
    node_name: "trait implementation scope-enter member declaration",
    range_description: "trait-implementation-scope-enter-member-declaration",
    debug_name: "TraitImplementationScopeEnterMemberDeclarationSyntax",
    builder_debug_name: "TraitImplementationScopeEnterMemberDeclarationSyntaxBuilder",
    keyword_getter: enter_keyword,
    keyword_push: push_enter_keyword,
    keyword_kind: SyntaxKind::EnterKeyword,
    keyword_slot: "trait_implementation_scope_enter_member_declaration.enter_keyword",
    modifiers_getter: async_capable_lifecycle_member_modifiers,
    modifiers_push: push_async_capable_lifecycle_member_modifiers,
    modifiers_type: AsyncCapableLifecycleMemberModifiersSyntax,
    modifiers_kind: SyntaxKind::AsyncCapableLifecycleMemberModifiers,
...
define_lifecycle_body_node_with_optional_result! {
    ...
    source_slot: "trait_implementation_scope_exit_member_declaration.source",
    node_name: "trait implementation scope-exit member declaration",
    range_description: "trait-implementation-scope-exit-member-declaration",
    debug_name: "TraitImplementationScopeExitMemberDeclarationSyntax",
    builder_debug_name: "TraitImplementationScopeExitMemberDeclarationSyntaxBuilder",
    keyword_getter: exit_keyword,
    keyword_push: push_exit_keyword,
    keyword_kind: SyntaxKind::ExitKeyword,
    keyword_slot: "trait_implementation_scope_exit_member_declaration.exit_keyword",
    modifiers_getter: async_capable_lifecycle_member_modifiers,
    modifiers_push: push_async_capable_lifecycle_member_modifiers,
    modifiers_type: AsyncCapableLifecycleMemberModifiersSyntax,
    modifiers_kind: SyntaxKind::AsyncCapableLifecycleMemberModifiers,
