...
pub use native::{
    ...
    CHARACTER_SCALAR_VALUE_SYMBOL, CHARACTER_UNICODE_DATA_VERSION, CHARACTER_UTF8_LENGTH_SYMBOL,
    CLEANUP_INCIDENT_REPORTING_SYMBOL, COMPATIBLE_LANE_SELECTION_SYMBOL,
