...
pub use native::{
    ...
    PLATFORM_STREAM_FLUSH_SYMBOL, PLATFORM_STREAM_LOCK_SYMBOL, PLATFORM_STREAM_READ_SYMBOL,
    PLATFORM_STREAM_UNLOCK_SYMBOL, PLATFORM_STREAM_WRITE_SYMBOL, ROOT_CANCELLATION_REQUEST_SYMBOL,
