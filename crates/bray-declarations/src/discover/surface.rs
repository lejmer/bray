use bray_syntax::{
    ...
    StructDeclarationSyntax, StructFieldDeclarationSyntax, SyntaxKind, SyntaxNodeView, SyntaxToken,
...
// rust-style: allow(function-too-large, reason = "the exhaustive declaration-kind dispatch is kept centralized so every syntax kind has one visible mapping")
