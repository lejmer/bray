...
const CHECKING_RANGE_ELEMENT_TYPE_MUST_BE_INTEGER: &[MessageTemplatePart] = &[
    MessageTemplatePart::Text("range elements and bounds must use one integer type, but found "),
    MessageTemplatePart::Arg(DiagnosticArgName::ActualType),
];
...
pub(crate) const fn diagnostic_template(kind: DiagnosticKind) -> MessageTemplate {
    match kind {
        ...
        DiagnosticKind::CheckingRangeElementTypeMustBeInteger => {
            MessageTemplate::new(CHECKING_RANGE_ELEMENT_TYPE_MUST_BE_INTEGER)
        }
        ...
        DiagnosticKind::CheckingUnknownExecutionProperty => MessageTemplate::new(&[
            MessageTemplatePart::Text("unknown execution property "),
            MessageTemplatePart::Arg(DiagnosticArgName::ReferencedName),
        ]),
        DiagnosticKind::CheckingExecutionGuaranteeNotProven => MessageTemplate::new(&[
