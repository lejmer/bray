...
fn format_english_platform_service_role(
    ...
    match role.id() {
        ...
        0x0321 => "thread creation operation",
        0x0322 => "thread join operation",
        0x0323 => "thread detachment operation",
        0x0331 => "thread storage creation operation",
        0x0332 => "thread storage load operation",
        0x0333 => "thread storage store operation",
        0x0334 => "thread storage destruction operation",
