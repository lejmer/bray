...
#[cfg(any(test, feature = "generation"))]
const SOURCES: [CatalogSource; 20] = [
    CatalogSource::new(
    ...
    CatalogSource::new(
        ...
        CatalogKind::CompilerKnown,
        "catalog/core/atomic.braydef",
        include_str!("../../catalog/core/atomic.braydef"),
    ),
    CatalogSource::new(
    ...
    CatalogSource::new(
        CatalogSourceId::new(17),
        CatalogKind::CompilerKnown,
        "catalog/ambient/capabilities.braydef",
        include_str!("../../catalog/ambient/capabilities.braydef"),
    ),
    CatalogSource::new(
        CatalogSourceId::new(18),
        CatalogKind::CompilerKnown,
        "catalog/ambient/sequence.braydef",
        include_str!("../../catalog/ambient/sequence.braydef"),
    ),
    CatalogSource::new(
        CatalogSourceId::new(19),
        CatalogKind::CompilerKnown,
        "catalog/ambient/nullable.braydef",
        include_str!("../../catalog/ambient/nullable.braydef"),
    ),
];
