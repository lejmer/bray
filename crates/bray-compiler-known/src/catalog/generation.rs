...
mod tests {
    ...
    fn published_catalog_contains_the_closed_conformance_entries() {
        ...
        let expected = [
            ...
            "StandardCharacterAlphabeticPrimitive",
            "StandardCharacterCodePoint",
            "StandardCharacterCodePointPrimitive",
            "StandardCharacterEncodeUtf8",
            "StandardCharacterFromCodePoint",
            "StandardCharacterFromCodePointPrimitive",
            "StandardCharacterImplementation",
            "StandardCharacterIsAlphabetic",
            "StandardCharacterIsNumeric",
            "StandardCharacterIsWhitespace",
            "StandardCharacterNumericPrimitive",
            "StandardCharacterUtf8BytePrimitive",
            "StandardCharacterUtf8Encoding",
            "StandardCharacterUtf8EncodingAsSlice",
            "StandardCharacterUtf8EncodingBytes",
            ...
            "StandardStringAsBytes",
            "StandardStringBytesPrimitive",
            "StandardStringCharacters",
            "StandardStringDecodeUtf8Primitive",
            "StandardStringEmptyPrimitive",
            "StandardStringEqualityPrimitive",
            "StandardStringEquatableEquals",
            "StandardStringEquatableImplementation",
            "StandardStringFromUtf8",
            "StandardStringGet",
            "StandardStringGetPrimitive",
            "StandardStringImplementation",
            "StandardStringIsEmpty",
            "StandardStringLength",
            "StandardStringLengthPrimitive",
            "StandardStringSlice",
            "StandardStringSlicePrimitive",
