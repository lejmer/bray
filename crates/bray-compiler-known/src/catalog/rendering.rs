...
pub(super) fn render_catalog(catalog: &CompilerKnownCatalog, digest: &str) -> String {
    let mut output = String::from(
        "// @generated by `cargo xtask compiler-known generate`. Do not edit.\n\n\
         // bray-style: allow(module-too-large, reason = \"the generated compiler-known catalog is intentionally a flat data table\")\n\
         use std::borrow::Cow;\n\n\
         ...
         // bray-style: allow(wildcard-import, reason = \"the generated catalog references a machine-generated symbol inventory\")\n\
         use super::super::*;\n\n",
    );
