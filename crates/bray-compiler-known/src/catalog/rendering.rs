...
pub(super) fn render_catalog(
    ...
    let mut output = String::from(
        "// @generated by `cargo xtask compiler-known generate`. Do not edit.\n\n\
         // rust-style: allow(module-too-large, reason = \"the generated compiler-known catalog is intentionally a flat data table\")\n\
         use std::borrow::Cow;\n\n\
         use bray_source::{TextRange, TextSize};\n\
         use bray_syntax::SyntaxKind;\n\n\
         use crate::{AvailabilityRule, CatalogGrammarRevision, CompilerKnownIterationRole, CompilerKnownOperationRole, ImplementationHook, RepresentationRole};\n\n\
         // rust-style: allow(wildcard-import, reason = \"the generated catalog references a machine-generated symbol inventory\")\n\
         use super::super::*;\n\n",
    );

    output.push_str(&format!(
        "/// Grammar revision used to interpret the generated catalog sources.\n\
         pub const CATALOG_GRAMMAR_REVISION: CatalogGrammarRevision = CatalogGrammarRevision::new({});\n\n\
         /// Digest of the revisioned canonical catalog source identity.\n\
         pub const CATALOG_SOURCE_DIGEST: &str = {digest:?};\n\n",
        grammar_revision.raw()
    ));
