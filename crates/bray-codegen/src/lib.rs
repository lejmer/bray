...
pub use mapping::{
    ...
    CodegenIntegerExtension, CodegenMappings, CodegenMappingsBuildError, CodegenOperationMapping,
    CodegenParameterMapping, CodegenProductHostMapping, CodegenProductHostStatic,
    CodegenResultMapping, CodegenSourceFile, CodegenStaticInstanceKey, CodegenStaticStorageMapping,
    CodegenStaticWitness, CodegenSymbolKey, CodegenSymbolMapping, CodegenTerminatorMapping,
    CodegenTypeBehavior, CodegenTypeKind, CodegenTypeMapping, CodegenUnionVariantLayout,
    CodegenValueAttribute, ConstantDemands, DemandedCallableInstance, IntrinsicCall,
    ...
    demanded_constants, demanded_debug_sources, demanded_runtime_references,
