...
use bray_ir::{MirTargetContract, MirUnit, MirUnitId};
...
impl CodegenUnit {
    ...
    fn try_from_partition(
        ...
        // The unit owns target properties independently of its instance collection.
    ...
    /// Returns target properties shared by every contained concrete definition.
